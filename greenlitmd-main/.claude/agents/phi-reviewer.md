---
name: phi-reviewer
description: Reviews any diff touching chart ingestion, API routes, or DB writes for PHI leakage and access-control gaps. Run on changes to /api/generate-pa, /api/suggest-fix, /api/regenerate-denial-fix, lib/deidentify.ts, or any Supabase query touching patient data.
